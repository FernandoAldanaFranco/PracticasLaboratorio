...
//Control de servomotores con movimiento bidireccional.
/*Este programa permite el control de servomotores mediante la biblioteca servo.h
 * Genera angulós en una y otra dirección
*/
...
void loop() {
  ...
  delay(1000);
  servoMotor.write(45);//Servo a 90°
  delay(1000);
  servoMotor.write(0);//Servo a posición de origen
  delay(1000);
  servoMotor.write(90);//Servo a 180°
  delay(1000);
  servoMotor.write(0);//Servo a posición de origen
  delay(1000);
  servoMotor.write(180);//Servo a 180°
  delay(1000);
  servoMotor.write(45);//Servo a 45°
  delay(1000);
  servoMotor.write(270);//Servo a 270°
  delay(1000);
  servoMotor.write(70);//Servo a 45°
  delay(1000);
}
